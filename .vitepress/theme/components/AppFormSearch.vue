<template>
    ...
    <div class="w-full border border-gray-300 bg-gray-100 text-gray-400 rounded-lg">
        <div class="relative px-4 flex gap-2 items-center">
            ...
            <input 
                ...
                type="text" 
                placeholder="Search"
                class="appearance-none outline-0 py-2"
            />
            <div class="flex gap-1 text-sm text-gray-400 bg-gray-200 items-center px-2 py-1 rounded">
                <span class="size-4">
